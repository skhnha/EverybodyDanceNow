...
class Trainer(object):
    ...
    def save_models(self, generator, discriminator, batch_num):
        if os.path.isfile(os.path.join(self.ckpt_dir, '%05d_generator.pth' % (batch_num-5))):
            os.remove(os.path.join(self.ckpt_dir, '%05d_generator.pth' % (batch_num-5)))
        if os.path.isfile(os.path.join(self.ckpt_dir, '%05d_discriminator.pth' % (batch_num - 5))):
            os.remove(os.path.join(self.ckpt_dir, '%05d_discriminator.pth' % (batch_num - 5)))
    ...
    def validate_and_save(self, generator, batch_num):
        ...
        if os.path.isfile(os.path.join(self.log_dir, '%05d_enhanced_head.png' % (batch_num - 5))):
            os.remove(os.path.join(self.log_dir, '%05d_enhanced_head.png' % (batch_num - 5)))
        if os.path.isfile(os.path.join(self.log_dir, '%05d_enhanced_full.png' % (batch_num - 5))):
            os.remove(os.path.join(self.log_dir, '%05d_enhanced_full.png' % (batch_num - 5)))
